...
function SettingsContent() {
  ...
  const hasPremiumAccess = !!user && (user.isSuperAdmin || user.isPremium);
  ...
  useEffect(() => { if (hasPremiumAccess) void loadTeam(); }, [hasPremiumAccess]);
