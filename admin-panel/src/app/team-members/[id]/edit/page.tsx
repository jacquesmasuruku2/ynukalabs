...
type Form = { name: string; slug: string; role: string; description: string; imageUrl: string; imageAlt: string; xUrl: string; linkedinUrl: string; telegramUrl: string; portfolioUrl: string; isActive: boolean };
const empty: Form = { name: '', slug: '', role: '', description: '', imageUrl: '', imageAlt: '', xUrl: '', linkedinUrl: '', telegramUrl: '', portfolioUrl: '', isActive: true };
