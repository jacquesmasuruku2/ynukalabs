    ...
    <AdminLayout>
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-primary">Nouvelle catégorie</h1>
            <p className="text-secondary mt-1">Créer une nouvelle catégorie</p>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="card rounded-lg shadow-sm border p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="mt-2 w-full h-10 border rounded-md cursor-pointer"
