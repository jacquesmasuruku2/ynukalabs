...
async function ensureAdminSchema() {
  ...
  const queries = [
    ...
    `CREATE TABLE IF NOT EXISTS public."AdminInvite" ("id" STRING PRIMARY KEY, "email" STRING NOT NULL, "name" STRING, "tokenHash" STRING NOT NULL UNIQUE, "expiresAt" TIMESTAMPTZ NOT NULL, "acceptedAt" TIMESTAMPTZ, "invitedById" STRING NOT NULL, "adminUserId" STRING UNIQUE, "createdAt" TIMESTAMPTZ NOT NULL DEFAULT now());`,
