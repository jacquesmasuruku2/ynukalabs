...
//    (must be https://your-domain.com/api.php?action=google_callback)
...
define('GOOGLE_REDIRECT_URI',  getenv('GOOGLE_REDIRECT_URI')  ?: 'https://ynukalabs.com/api.php?action=google_callback');
define('PANEL_URL',            getenv('PANEL_URL')            ?: 'https://admin.ynukalabs.com/dashboard'); // where to send user after login
